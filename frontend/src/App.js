  ...
  return (
    <div className="App">
      <div>
        ...
        <div className='flex'>
          <aside id="cta-button-sidebar" className="flex-none top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
              ...
              <ul className="space-y-2 font-medium">
                ...
                <li>
                  <a href="/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Docx to PDF</span>
          ...
          <div className="grow w-full h-screen p-8" onDragOver={handleDragOver} onDrop={handleDrop} onDragLeave={handleDragLeave}>
            <label className={`flex ${file.length === 0 && 'justify-center'} w-full h-full transition bg-white border-2 border-gray-300 border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-400 focus:outline-none`}>
              <span className={`flex ${file.length === 0 && 'items-center'} space-x-2`}>
                {
                  file.length !== 0 ? (
              ...
              <input type='file' name='file' onChange={handleInput} className="hidden" />
            </label>
          </div>
        </div>
        {/* <div>
